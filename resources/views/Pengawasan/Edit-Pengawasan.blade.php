...
{{-- </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <div class="form-group mt-3">
                                                <label>Jenis Sk:</label>
                                                <input type="text" id="jenis_sk" name="jenis_sk"
                                                    class="form-control" value="{{ $item->jenis_sk }}" />
                                                <div>
                                                    <div class="form-group mt-3">
                                                        <label>Tinda Lanjut:</label>
                                                        <input type="text" id="tdklanjut" name="tdklanjut"
                                                            class="form-control" value="{{ $item->tdklanjut }}" />
                                                        <div>
                                                            <div class="form-group mt-3">
                                                                <label>Kesesuaian:</label>
                                                                ...
                                                                <div class="form-group mt-3">
                                                                    <button type="submit" class="btn btn-primary"
                                                                        style="background-color: brown">Ubah Data</button>
                                                                </div>
